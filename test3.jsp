...
<head>
  ...
  <div id="auth-buttons">
    ...
    <button type="button" class="" data-bs-toggle="modal" data-bs-target="#signupModal">회원가입</button>
  </div>
    <!-- 메인 화면 메뉴 구성 -->
    <!-- 게시판 메뉴 및 로고 -->
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        ...
        <!-- 로고 -->
        <a class="nav-link" href="main.jsp"><img id="logo" src="logo.png" alt="MovieMate 로고"></a>
          ...
          <ul class="menu">           <!--메뉴 묶음-->
            <li>
              <a class="nav-link" href="#">이벤트</a>
                <ul class="submenu">                      <!-- 서브 메뉴 항목-->
                  <li><a href="OngoingEvent.jsp">진행중 이벤트</a></li>
                  <li><a href="">당첨자 발표</a></li>
                  <li><a href="pastEvent.jsp">지난 이벤트</a></li>
                </ul>
            </li>
            <li>
