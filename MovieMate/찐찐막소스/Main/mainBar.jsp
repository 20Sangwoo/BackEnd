...
<body style="z-index: 5;">
	...
	<div id="auth-buttons">
        ...
        <% } else { %>
            ...
            <button type="button" id="mypage" onclick="location.href='../Member/myPage.jsp'">
                마이페이지
            </button>
        <% } %>
     </div>
	...
	<div class="modal fade" id="signupModal">
    	<div class="modal-dialog">
        	<div class="modal-content">
            	...
            	<div class="modal-body">
            		<form action="../Member/signupPro.jsp" method="post">
            			<div class="form-group">
            				<label for="id">ID:</label>
            		 		<input type="text" class="form-control" id="id" name="id">
            			</div>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <div class="left-nav">
            <ul class="menu">
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="../Movie/movieList.jsp">상영 중인 영화</a></li>
                    </ul>
                </li>
                <li>
        ...
        <!-- 로고 -->
        <a class="nav-link" href="../Main/main.jsp"><img id="logo" src="../img/logo.png" alt="MovieMate 로고"></a>
        ...
        <div class="right-nav">
            <ul class="menu">
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="../Event/evList.jsp">현재 이벤트</a></li>
                    </ul>
                </li>
                <li>
                    <a class="nav-link" href="#">게시판</a>
                    <ul class="submenu">
                         <li><a id="notice-link" href="../Notice/noticeList.jsp">공지사항</a></li>
                        <li><a href="../QA/qaList.jsp">Q&A</a></li>
                    </ul>  
                </li>
            </ul>
        </div>
